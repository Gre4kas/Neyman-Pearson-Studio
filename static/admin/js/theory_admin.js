...
(function() {
  ...
  document.addEventListener('DOMContentLoaded', function(){ ensureMathJax(function(){ setupLivePreview(); setTimeout(function(){ if(document.getElementById('uploadedImagesList')) loadUploadedImages(); }, 500); }); });
})();